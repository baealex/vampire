...
import { terminalColorReport, type TerminalColorSlot } from '../src/lib/terminal/color-report.ts';
import { terminalSubmissionData, terminalSubmissionSettleMs } from '../src/lib/terminal/submission.ts';

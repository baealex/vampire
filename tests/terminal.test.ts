...
test('crops a saved main-screen cursor when a TUI outlives a pane shrink', () => {
	const state = terminalPaneState(
		'1\t90\t36\t0\t1\t6\t11\t0\t0\t0\t0\t1\t0\t22\n',
		{ columns: 63, rows: 23 }
	);
	assert.ok(state);
...
test('ignores tmux alternate-screen cursor sentinels while on the main screen', () => {
	const state = terminalPaneState(
		'0\t4294967295\t4294967295\t0\t1\t17\t4\t0\t0\t0\t0\t1\t0\t23\n',
		{ columns: 80, rows: 24 }
	);
	assert.ok(state);
...
test('restores the cursor on tmux versions without bracketed-paste state', () => {
	const state = terminalPaneState(
		'0\t4294967295\t4294967295\t\t1\t17\t4\t0\t0\t0\t0\t1\t0\t23\n',
		{ columns: 80, rows: 24 }
	);
	assert.ok(state);
...
test('rebuilds a pending-autowrap cursor by rewriting its physical row', () => {
	const state = terminalPaneState(
		'0\t4294967295\t4294967295\t0\t1\t5\t0\t0\t0\t0\t0\t1\t0\t1\n',
		{ columns: 5, rows: 2 }
	);
	assert.ok(state);

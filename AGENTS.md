...
- Treat this repository as React + Fastify domain modules, not strict Feature-Sliced Design.
- Preserve the real browser/server boundary over visual directory symmetry.
...
- Keep React application code in `packages/client/src`; Fastify owns the production HTTP runtime.

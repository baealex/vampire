...
import BackgroundProcesses from '~/lib/features/terminal/BackgroundProcesses.svelte';
import GlobalStatusBar from '~/lib/features/status/GlobalStatusBar.svelte';
import TerminalHeader from '~/lib/features/terminal/TerminalHeader.svelte';
import TerminalViewport from '~/lib/features/terminal/TerminalViewport.svelte';

...
export const SUPPORTED_IMAGE_TYPES = new Set(['image/avif', 'image/gif', 'image/jpeg', 'image/png', 'image/webp']);
...
export function pasteImageToWorkspace(input: { tmuxTarget: string; bytes: Buffer; mimeType: string }): Promise<void> {

...
import { installTerminalWebSocket } from '~/server/terminal/websocket.ts';
import { installWorkspaceWebSocket } from '~/server/workspace/workspace-websocket.ts';
import { installWorkspaceAutomationRunner } from '~/server/workspace/workspace-automations.ts';
